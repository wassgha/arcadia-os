...
function PlaygroundScreen:new()
    ...
    instance.children = {Focusable:new(), Focusable:new(), Focusable:new(), Focusable:new(), Focusable:new(),
                         Focusable:new(), Focusable:new(), Focusable:new(), Focusable:new(), Focusable:new(),
                         Focusable:new()}
